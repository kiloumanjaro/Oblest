...
# Add the parent directory of Tasks to the sys.path
sys.path.append(os.path.join(os.path.dirname(__file__), '..'))

# Now you can import TaskManager
...
def create_tasks_page(app):
    ...
    # ==============================================
    # Section 2: Frame Initialization
    # ==============================================
    ...
    # frame_text = ttk.Frame(frame_tasks, bootstyle="primary", padding=10)
    # frame_text.pack(fill="x", padx=10, pady=5)

    # frame_days = ttk.Frame(frame_tasks, bootstyle="primary", padding=5)
    # frame_days.pack(fill="x", padx=10, pady=0, anchor="center")

    # frame_empty = ttk.Frame(frame_tasks, bootstyle="primary", padding=5)
    # frame_empty.pack(fill="x", padx=10, pady=(10, 5))

    # overlay_frame = ttk.Frame(frame_tasks, bootstyle="primary", padding=10)

    frame_tasks = ttk.Frame(frame_taskpage, bootstyle="primary")
    frame_tasks.pack(fill="both", expand=True)


    frame_pages = ttk.Frame(frame_taskpage, padding=5)
