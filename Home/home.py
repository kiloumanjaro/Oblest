...
def create_home_page(app):
    ...
    frame_controls = ttk.Frame(frame_home, padding=0)
    ...
    frame_circle = ttk.Frame(frame_home, bootstyle="primary", padding=10)
    frame_circle.pack(fill="x", padx=10, pady=10)

    frame_days = ttk.Frame(frame_home, bootstyle="primary", padding=5)
    frame_days.pack(fill="x", padx=10, pady=0, anchor="center")

    frame_progress = ttk.Frame(frame_home, bootstyle="primary", padding=5)
